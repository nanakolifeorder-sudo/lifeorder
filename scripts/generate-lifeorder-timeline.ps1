...
$bodyFont = New-Object System.Drawing.Font($font, 20)
$focusFont = New-Object System.Drawing.Font($font, 18, [System.Drawing.FontStyle]::Bold)
...
$stages = @(
  @{ Age='0-20歲'; Name='探索自己'; Color='#6B9238'; Points=@('認識自己與興趣','建立學習習慣','家庭支持與價值觀'); Focus='建立自我與價值觀基礎' },
  @{ Age='20-30歲'; Name='建立基礎'; Color='#3F75B5'; Points=@('職涯探索與發展','建立人際與社交圈','財務基礎與理財'); Focus='累積能力與生活基礎' },
  @{ Age='30-45歲'; Name='平衡發展'; Color='#2D9A8A'; Points=@('事業與自我實現','家庭經營與關係','資產累積與風險'); Focus='平衡工作、家庭與自我' },
  @{ Age='45-60歲'; Name='整合安排'; Color='#D86F1F'; Points=@('資產穩定與優化','下一代與傳承準備','生活品質與健康'); Focus='整合人生，開始傳承規劃' },
  @{ Age='60-75歲'; Name='豐盛投入'; Color='#8055A0'; Points=@('生活與興趣投入','分享經驗回饋社會','重要安排逐步完成'); Focus='持續創造價值與豐盛' },
  @{ Age='75歲以上'; Name='傳承心意'; Color='#D96F79'; Points=@('精神傳承與延續','陪伴家人珍惜當下','留下愛與祝福'); Focus='安心生活，傳承愛與祝福' }
)
