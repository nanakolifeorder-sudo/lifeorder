...
function buildCrmWorkbook() {
  ...
  leads.getRange("A2:J5").values = [
    ["王小明", "example@example.com", "0900000000", "Google表單", "新名單", "高意願,待追蹤", "這裡放客戶備註", "LO", "顧問姓名", "2026-08-28"],
    ["", "", "", "", "", "", "", "", "", ""],
    ["", "", "", "", "", "", "", "", "", ""],
    ["", "", "", "", "", "", "", "", "", ""],
  ];
...
function buildQuizWorkbook() {
  ...
  questions.getRange("A2:K6").values = [
    ["LO", "預設版本", "第一階段：目前狀態", "先了解目前狀況", "你目前最想解決的是什麼？", "單選", "是", "我已經想清楚，正在找適合方案", "需求清晰度", 5, 10],
    ["LO", "預設版本", "第一階段：目前狀態", "先了解目前狀況", "你目前最想解決的是什麼？", "單選", "是", "知道下一步怎麼做", "需求清晰度", 3, 20],
    ["LO", "預設版本", "第二階段：期待與補充", "確認想改善方向", "你期待諮詢後得到什麼？", "複選", "是", "釐清問題、知道下一步怎麼做", "執行準備度", 5, 30],
    ["", "", "", "", "", "", "", "", "", "", ""],
    ["", "", "", "", "", "", "", "", "", "", ""],
  ];
  ...
  guide.getRange("A3:E10").values = [
    ["欄位", "是否必填", "填寫方式", "範例", "說明"],
    ["專案代碼", "必填", "文字", "LO", "對應後台專案，通常由工程師或管理者提供。"],
