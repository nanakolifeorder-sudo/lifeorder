...
function extractDemographics(answerRows, rawAnswers = {}) {
  const result = { ageGroup: "", ageGroupLabel: "", identity: "", hasPets: null };
  if (rawAnswers && typeof rawAnswers === "object") {
    result.ageGroup = normalizeAgeGroup(rawAnswers._profile_age || rawAnswers.age || rawAnswers.age_group);
